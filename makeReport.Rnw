...
<<map1, fig.height=4, dpi=200, eval=TRUE, echo=FALSE, message=FALSE, dev="png", include=FALSE, cache=FALSE, dev.args=list(bg='transparent')>>=
...
<<map2, fig.height=4, dpi=200, eval=TRUE, echo=FALSE, message=FALSE, dev="png", include=FALSE, cache=FALSE, dev.args=list(bg='transparent')>>=
plot_forecast_map(forecast_data=forecasts, 
                  cdata=dat, 
                  include_legend=FALSE,
...
<<map3, fig.height=4, dpi=200, eval=TRUE, echo=FALSE, message=FALSE, dev="png", include=FALSE, cache=FALSE, dev.args=list(bg='transparent')>>=
plot_forecast_map(forecast_data=forecasts, 
                  cdata=dat, 
                  biweek=current_biweek+1, 
                  include_legend=TRUE,
