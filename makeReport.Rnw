...
# DATA_THRU_WEEK <- week(Sys.Date())

ANALYSIS_DATE <- '20140910' #as.character(Sys.Date(), "%Y%m%d")
DELIVERY_DATE <- '20140910' #as.character(Sys.Date(), "%Y%m%d")
