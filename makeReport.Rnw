...
DATA_THRU_WEEK <- 44 ## number from Thai filename 
transmittal_date <- "20141113" ## date data transmitted from thais
        
ANALYSIS_DATE <- "20141118" #as.character(Sys.Date(), "%Y%m%d")
DELIVERY_DATE <- "20141117" #as.character(Sys.Date(), "%Y%m%d") ## del date used in data pulls
